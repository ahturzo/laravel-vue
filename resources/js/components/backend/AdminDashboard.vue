        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6 col-md-12">
                <div class="card white bg-warning text-center">
                    <div class="card-content">
                        <div class="card-body">
                            <img src="robust/app-assets/images/elements/04.png" alt="element 05" height="170" class="mb-1">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <span class="avatar avatar-xs"><img src="/robust/app-assets/images/portrait/small/avatar-s-4.png" alt="avatar"></span> <span>Sarah W.</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <span class="avatar avatar-xs"><img src="/robust/app-assets/images/portrait/small/avatar-s-5.png" alt="avatar"></span> <span>Edward C.</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <span class="avatar avatar-xs"><img src="/robust/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"></span> <span>Carol E.</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <span class="avatar avatar-xs"><img src="/robust/app-assets/images/portrait/small/avatar-s-7.png" alt="avatar"></span> <span>Gregory L.</span>
                                    </td>
                                    <td class="text-truncate"><span class="tag tag-success">Low</span></td>
                                    <td class="valign-middle">
                                        <div class="progress m-0" style="height: 7px;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <span class="avatar avatar-xs"><img src="/robust/app-assets/images/portrait/small/avatar-s-8.png" alt="avatar"></span> <span>Susan S.</span>
                                    </td>
                                    <td class="text-truncate"><span class="tag tag-warning">Medium</span></td>
                                    <td class="valign-middle">
                                        <div class="progress m-0" style="height: 7px;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <span class="avatar avatar-xs"><img src="/robust/app-assets/images/portrait/small/avatar-s-9.png" alt="avatar"></span> <span>Walter K.</span>
                                    </td>
                                    <td class="text-truncate"><span class="tag tag-danger">Critical</span></td>
                                    <td class="valign-middle">
                                        <div class="progress m-0" style="height: 7px;">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-12">
                <div class="card profile-card-with-cover border-grey border-lighten-2">
                    <div class="card-img-top img-fluid bg-cover height-200" style="background: url('robust/app-assets/images/carousel/16.jpg');"></div>
                    <div class="card-profile-image">
                        <img src="robust/app-assets/images/portrait/small/avatar-s-9.png" class="rounded-circle img-border" alt="Card image">
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12">
                ...
                <div class="card bg-warning text-center height-200">
                    <div class="card-content">
                        <div class="card-body">
                            <img src="robust/app-assets/images/elements/04.png" alt="element 05" height="110" class="mb-1">
            ...
            <div class="col-xl-4 col-lg-6 col-md-12">
                <div class="card card-inverse card-success text-center height-200">
                    <div class="card-content">
                        <div class="card-body">
                            <img src="robust/app-assets/images/elements/06.png" alt="element 05" height="110" class="mb-1">
...
<script>
    export default {
        ...
        created() {
            var scripts = [
                "/robust/app-assets/vendors/js/extensions/jquery.knob.min.js",
                "/robust/app-assets/vendors/js/charts/raphael-min.js",
                "/robust/app-assets/vendors/js/charts/morris.min.js",
                "/robust/app-assets/vendors/js/charts/chartist.min.js",
                "/robust/app-assets/vendors/js/charts/chart.min.js",
                "/robust/app-assets/vendors/js/charts/jquery.sparkline.min.js",
                "/robust/app-assets/vendors/js/extensions/moment.min.js",
                "/robust/app-assets/vendors/js/extensions/underscore-min.js",
                "/robust/app-assets/vendors/js/extensions/clndr.min.js",
                "/robust/app-assets/vendors/js/extensions/unslider-min.js",
                "/robust/app-assets/js/scripts/pages/dashboard-project.min.js"
            ];
...
<style lang="scss" scoped>
    @import '/robust/app-assets/vendors/css/charts/jquery-jvectormap-2.0.3.css';
    @import '/robust/app-assets/vendors/css/charts/morris.css';
    @import '/robust/app-assets/vendors/css/extensions/unslider.css';
    @import '/robust/app-assets/vendors/css/weather-icons/climacons.min.css';
    @import '/robust/app-assets/css/core/colors/palette-gradient.min.css';
    @import '/robust/app-assets/css/plugins/calendars/clndr.min.css';
    @import '/robust/app-assets/css/core/colors/palette-climacon.css';
    @import '/robust/app-assets/css/pages/users.min.css';
</style>
